...
OBJ=image_opencv.o http_stream.o gemm.o utils.o dark_cuda.o convolutional_layer.o list.o image.o activations.o im2col.o col2im.o blas.o crop_layer.o dropout_layer.o maxpool_layer.o softmax_layer.o data.o matrix.o network.o connected_layer.o cost_layer.o parser.o option_list.o darknet.o detection_layer.o captcha.o route_layer.o writing.o box.o nightmare.o normalization_layer.o avgpool_layer.o coco.o dice.o yolo.o detector.o layer.o compare.o classifier.o local_layer.o swag.o shortcut_layer.o representation_layer.o activation_layer.o rnn_layer.o gru_layer.o rnn.o rnn_vid.o crnn_layer.o demo.o tag.o cifar.o go.o batchnorm_layer.o art.o region_layer.o reorg_layer.o reorg_old_layer.o super.o voxel.o tree.o yolo_layer.o gaussian_yolo_layer.o upsample_layer.o lstm_layer.o conv_lstm_layer.o scale_channels_layer.o sam_layer.o pipeline.o pipeline_jitter.o sequential.o sequential_jitter.o sequential_multiblas.o data_parallel.o data_parallel_r_test.o data_parallel_r_test_jitter.o data_parallel_nano.o data_parallel_sleep.o data_parallel_jitter.o data_parallel_mp.o gpu_layer_test.o gpu_accel.o gpu_accel_sleep.o gpu_accel_pre_gpu.o gpu_accel_gpu.o gpu_accel_glayer.o gpu_accel_layer_test.o gpu_accel_reverse.o gpu_accel_gpu_copytime.o gpu_accel_mp.o gpu_accel_mp_reverse.o gpu_accel_nano.o cpu_reclaiming_mp.o cpu_reclaiming.o cpu_reclaiming_CRG.o cpu_reclaiming_RGC.o cpu_reclaiming_RCG.o cpu_reclaiming_GCR.o cpu_reclaiming_mp_RGC.o cpu_reclaiming_rlayer.o
ifeq ($(GPU), 1)
LDFLAGS+= -lstdc++
