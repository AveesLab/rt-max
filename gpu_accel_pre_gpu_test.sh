...
for var in $(seq 1 5 $layer_num)
do
    sleep 3s
    ./darknet detector gpu-accel_pre_gpu ./cfg/${data_file}.data ./cfg/${model}.cfg ./weights/${model}.weights data/dog.jpg -num_thread 11 -glayer $var -num_exp 20 
    sleep 3s
done
