...
// 정렬 비교 함수
static int compare_gpu_logs(const void *a, const void *b) {
...
// 로그 파일 작성 함수
static void write_logs_to_files(char *model_name, char *gpu_path, char *worker_path) {
    // GPU 로그 정렬 및 파일 작성
